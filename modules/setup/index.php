...
/**
 * Module 'setup' for the 'ddbfrontendviewer' extension.
*
* @author	Sebastian Meyer <sebastian.meyer@slub-dresden.de>
* @copyright	Copyright (c) 2012, Sebastian Meyer, SLUB Dresden
* @package	TYPO3
* @subpackage	tx_ddbfrontendviewer
* @access	public
*/
class tx_ddb_frontend_viewer_modSetup extends tx_dlf_module {

	public $extKey = 'ddb_frontend_viewer';

	public $prefixId = 'tx_ddb_frontend_viewer';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ddb_frontend_viewer/modules/setup/index.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/ddb_frontend_viewer/modules/setup/index.php']);
}

$SOBE = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance('tx_ddb_frontend_viewer_modSetup');
